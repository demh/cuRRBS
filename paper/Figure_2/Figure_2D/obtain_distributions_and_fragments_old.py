...
for element in all_enzymes:
    ...
    ##### 3. Create a dataframe that contains the following columns: Site_IDs, chromosome,
    #        coordinate, fragment start, fragment end, fragment length. Export this 
    #        information, in a collapsed format, as a CSV file.
    ...
    for i in range(0,len(extract_chromosomes)):
        ...
        extract_site_IDs.append(str(site_ID))
